    ...
    <InstructorRoute>
      ...
      {!courses.length && (
        <Link href="/instructor/course/create">
          <div className="btn btn-primary float-right mt-2">Create course</div>
        </Link>
      )}
      {courses &&
        courses.map((course) => (
          <div className="media pb-3" key={course._id}>
            ...
            <div className="media-body pl-2">
              <div className="row">
                ...
                <div className="mt-3 justify-content-end text-center col">
                  {course.published ? (
                    <div>
                      <CheckCircleOutlined className="h5 pointer text-success justify-content-end" />
                      <br />
                      <small className="text-muted">Published</small>
                    </div>
                  ) : (
                    <div>
                      <CloseCircleOutlined className="h5 pointer text-warning justify-content-end" />
                      <br />
